...
UPDATE public.products SET
  ...
  description = 'Kit Complet Klow 80mg conține: 1 flakon peptidă liofilizată Klow 80mg (puritate ≥99.0%), 1 flakon apă bacteriostatică 10ml și 1 seringă de reconstituire. Puritate verificată prin HPLC. Depozitați peptida la -20°C în ambalaj original sigilat. Exclusiv pentru cercetare în laborator.'
...
UPDATE public.products SET
  ...
  description = 'Kit Complet Retatrutida 10mg conține: 1 flakon peptidă liofilizată Retatrutida 10mg (puritate ≥98.5%), 1 flakon apă bacteriostatică 10ml și 1 seringă de reconstituire. Retatrutida este un agonist triplu al receptorilor GIP, GLP-1 și Glucagon. Puritate verificată prin HPLC. Exclusiv pentru cercetare în laborator.'
...
UPDATE public.products SET
  ...
  description = 'Kit Complet Retatrutida 20mg conține: 1 flakon peptidă liofilizată Retatrutida 20mg (puritate ≥98.5%), 1 flakon apă bacteriostatică 10ml și 1 seringă de reconstituire. Retatrutida este un agonist triplu al receptorilor GIP, GLP-1 și Glucagon. Puritate verificată prin HPLC. Exclusiv pentru cercetare în laborator.'
...
UPDATE public.products SET
  ...
  description = 'Kit Complet GHK-Cu 50mg conține: 1 flakon peptidă liofilizată GHK-Cu 50mg (puritate ≥99.0%), 1 flakon apă bacteriostatică 10ml și 1 seringă de reconstituire. GHK-Cu (Gly-His-Lys cupru) este un tripeptid de origine umană. Puritate verificată HPLC. Exclusiv pentru cercetare în laborator.'
...
UPDATE public.products SET
  ...
  description = 'Kit Complet Semax 10mg conține: 1 flakon peptidă liofilizată Semax 10mg (puritate ≥98.0%), 1 flakon apă bacteriostatică 10ml și 1 seringă de reconstituire. Semax este un analog sintetic al fragmentului ACTH(4-7) cu extensie Pro-Gly-Pro. Puritate verificată prin HPLC. Exclusiv pentru cercetare în laborator.'
...
UPDATE public.products SET
  ...
  description = 'Kit Complet Selank 10mg conține: 1 flakon peptidă liofilizată Selank 10mg (puritate ≥98.0%), 1 flakon apă bacteriostatică 10ml și 1 seringă de reconstituire. Selank este un heptapeptid sintetic derivat din tuftsin. Puritate verificată prin HPLC. Exclusiv pentru cercetare în laborator.'
...
UPDATE public.products SET
  ...
  description = 'Kit Complet BPC-157 10mg conține: 1 flakon peptidă liofilizată BPC-157 10mg (puritate ≥99.0%), 1 flakon apă bacteriostatică 10ml și 1 seringă de reconstituire. BPC-157 (Body Protection Compound-157) este un pentadecapeptid sintetic. Puritate verificată prin HPLC. Exclusiv pentru cercetare în laborator.'
